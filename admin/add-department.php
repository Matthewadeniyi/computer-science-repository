          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div class="flex flex-wrap justify-between gap-3 p-4">
              <div class="flex min-w-72 flex-col gap-3">
                <p class="text-[#1C160C] text-4xl font-black leading-tight tracking-[-0.033em]">Add Department Details</p>
            ...
            <form  method="post">
                ...
                <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
                  <label class="flex flex-col min-w-40 flex-1">
                    <p class="text-[#1C160C] text-base font-medium leading-normal pb-2">Department Name</p>
                    <input
                ...
                <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
                  <label class="flex flex-col min-w-40 flex-1">
                    <p class="text-[#1C160C] text-base font-medium leading-normal pb-2">Make visible</p>
                    <select required
                      name = 'visibility' 
                ...
                <div class="flex px-4 py-3 justify-center">
                  <button
                    name="addDepartment" type='submit'
            ...
            <h2 class="text-[#1C160C] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Departments</h2>
            <div class="flex justify-stretch">
              <div class="flex flex-1 gap-3 flex-wrap px-4 py-3 justify-start">
                ...
                >
                  <span class="truncate"> Manage Departments</span>
                </button>
                  ...
                  <tbody>
                    <?php 
                      ...
                      if(mysqli_num_rows($sql) <1){
                        echo '<td class="table-9cc7e0ed-2c6e-4a57-b806-43b914f94c23-column-240 h-[72px] px-4 py-2 w-[400px] text-[#1C160C] text-sm font-normal leading-normal">No records yet!</td>';
                      }
                      $i=1;
                    ...
                    <tr class="border-t border-t-[#E9DFCE]">
                      ...
                      <td class="table-9cc7e0ed-2c6e-4a57-b806-43b914f94c23-column-240 h-[72px] px-4 py-2 w-[400px] text-[#1C160C] text-sm font-normal leading-normal"><?=$rows['department_name']?></td>
                      <td class="table-9cc7e0ed-2c6e-4a57-b806-43b914f94c23-column-240 h-[72px] px-4 py-2 w-[400px] text-[#1C160C] text-sm font-normal leading-normal"><?=$pro->showStatus($rows['visible'])?></td>
                    </tr>
                  <?php } ?>
                  </tbody>
                </table>
