        ...
        <div class="gap-1 px-6 flex flex-1 justify-center py-5">
          ...
          <div class="flex gap-3">
                  ...
                  <div class="flex flex-col">
                    <h1 class="text-[#1C160C] text-base font-medium leading-normal"><?=$_SESSION['admin_name']?>'s Profile</h1>
                    <p class="text-[#A18249] text-sm font-normal leading-normal">Laboratory</p>
                  </div>
                </div>
            ...
            <?php
              $sql = $db->query("SELECT * FROM admin WHERE admin_no ='{$_SESSION['admin_no']}' ");
